...
/**
 * Navbar Component
 * แถบนำทางหลักของเว็บไซต์ รองรับทั้งการแสดงผลบน Desktop และ Mobile (Responsive)
 * มีระบบตรวจจับการ Scroll เพื่อเปลี่ยนลักษณะการแสดงผล (Transparency -> Glassmorphism)
 */
...
export default function Navbar() {
  ...
  // รายการลิงก์เมนูหลักประจำเว็บไซต์
  const links = [
    { href: '/', label: 'หน้าแรก' },
    { href: '/products', label: 'สินค้า' },
  ];

  // ตรวจสอบว่าลิงก์ใดคือหน้าปัจจุบัน เพื่อแสดงสถานะ Active (ตัวหนา/ขีดเส้นใต้)
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-6 flex items-center justify-between">
        ...
        {/* รายการเมนูสำหรับหน้าจอขนาดใหญ่ (Desktop Menu) */}
      ...
      {/* เมนูแบบ Dropdown เมื่อแสดงผลบนมือถือ (Mobile Menu) */}
      {menuOpen && (
